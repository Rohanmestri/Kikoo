...
public class TensorFlowObjectDetectionAPIModel implements Classifier {
  ...
  private int inputSize_1;
  private int inputSize_2;
  ...
  public static Classifier create(
      ...
      final int inputSize_1,final int inputSize_2) throws IOException {
    ...
    d.inputSize_1= inputSize_1;
    d.inputSize_2= inputSize_2;
    ...
    d.intValues = new int[d.inputSize_1 * d.inputSize_2];
    d.byteValues = new byte[d.inputSize_1 * d.inputSize_2 * 3];
  ...
  public List<Recognition> recognizeImage(final Bitmap bitmap) {
    ...
    System.out.println("The bitmap size is"+bitmap.getWidth()+"and"+bitmap.getHeight());
    ...
    inferenceInterface.feed(inputName, byteValues, 1, inputSize_1, inputSize_2, 3);
    Trace.endSection();
    ...
    for (int i = 0; i < outputScores.length; ++i) {
      final RectF detection =
          new RectF(
              outputLocations[4 * i + 1] * inputSize_1,
              outputLocations[4 * i] * inputSize_2,
              outputLocations[4 * i + 3] * inputSize_2,
              outputLocations[4 * i + 2] * inputSize_1);
      pq.add(
